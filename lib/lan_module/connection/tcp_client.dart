/// TCP Client for Outgoing Messages
///
/// Provides TCP client functionality to send messages to other devices.
...
/// TCP Client for sending LAN messages
///
/// Responsible for:
/// - Establishing TCP connections to remote devices
/// - Serializing and sending messages
/// - Managing connection state and retries
